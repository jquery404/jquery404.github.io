...
# Create a data frame with the comparison parameters
comparison_data <- data.frame(
  System = c("MRMAC", "MRMAC", "MRMAC", "MRMAC", "MRMAC", "AVT", "AVT", "AVT", "AVT", "AVT"),
  Parameter = c("Data Size", "Capturing & Processing Time", "Networking Time", "Rendering Time", "Network Latency",
               "Data Size", "Capturing & Processing Time", "Networking Time", "Rendering Time", "Network Latency"),
  Score = c(8, 9, 9, 9, 8, 6, 4, 4, 5, 4)
)

# Create a comparison plot using ggplot2
comparison_plot <- ggplot(comparison_data, aes(x = Parameter, y = Score, fill = System)) +
  geom_bar(stat = "identity", position = position_dodge(width = .65), width = .55) +
  scale_fill_manual(values = c("MRMAC" = "#E76469", "AVT" = "#F8D85E")) +
  scale_color_manual(values = c("MRMAC" = "#E76469", "AVT" = "#F8D85E")) +
  labs(title = "MRMAC vs AVT Comparison",
       x = "Parameters",
