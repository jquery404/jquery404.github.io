...
# Add facet grid
p <- p + facet_grid(vars(qus), vars(cyl),switch = "y") + xlab("Preference questions") + ylab(NULL) + 
...
p <- p + geom_bar(stat = 'identity', position = 'stack') + facet_grid(~ conditions)

# Customize the chart appearance
p <- p + xlab("Category") + ylab("Value") + ggtitle("Stacked Bar Chart") + theme_bw() + theme(legend.position="null", axis.line = element_blank(),
...
# saving the final figure
ggsave("out/preference.pdf", final_plot, width = 7, height = 4, dpi = 1000)
```
